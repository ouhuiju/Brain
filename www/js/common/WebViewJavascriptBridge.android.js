...
var webViewBridge = (function () {
    ...
    var registerJSHandler = function (functionName, responseCallback) {
        ...
        bridge(function () {
           param.bridge.registerHandler(functionName, function (responseData,callback) {
              ...
              responseCallback(responseData,callback);
           });
        });
    };
    ...
    var callNativeHandler = function (functionName, data, responseCallback) {
        bridge(function () {
            param.bridge.callHandler(functionName, data, function (responseData) {
                if (typeof responseData == 'string') {
                    try{
                        responseData = JSON.parse(responseData);
                    }
